...
const Header = () => {
    return (
   <nav className="nav flex  flex-wrap items-center justify-between px-4 shadow-2xl relative bg-gray-900 ">
  ...
  <ul className="menu text-black border-b md:border-none flex justify-end list-reset m-0 w-full md:w-auto">
    <li className="border-t md:border-none">
      <Link href="/" className="block md:inline-block px-4 py-3 no-underline text-white hover:text-grey-darker font-bold">Home</Link>
    </li>
    <li className="border-t md:border-none">
      <Link href="/login" className="block md:inline-block px-4 py-3 no-underline text-white hover:text-grey-darker">Editor</Link>
    </li>
    <li className="border-t md:border-none">
      <Link href="/template" className="block md:inline-block px-4 py-3 no-underline text-white hover:text-grey-darker">Template</Link>
    </li>
  </ul>
</nav>
