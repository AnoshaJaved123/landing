...
export default (editor, opts = {}) => {
    ...
    *{
    ...
    .jotform-icon{
      background-image:url("https://files.startupranking.com/startup/thumb/37832_dd0dcdb7463391d8ee4a9b7468e9f5aa930e359e_jotform_m.png");
      background-repeat:no-repeat;
      background-size:cover;
      width:50px;
      height:50px;
    ...
    bm.add(opts.name, {
      label: `
      <img class='labelimg' src='/yellow.png'/>
      <div class="gjs-block-label">
        ${opts.label}
      </div> 
      `,
      category: opts.category,
      content: `<link href="https://fonts.googleapis.com/css?family=Quicksand:400,500,700&display=swap" rel="stylesheet">
