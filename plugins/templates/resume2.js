...
export default (editor, opts = {}) => {
    ...
    bm.add(opts.name, {
      label: `
      <img class='labelimg' src='/portfolio.png'/>
      ...
      <html lang="en">
          ...
          <body data-bs-spy="scroll" data-bs-target="#nav-scroll" data-offset="56">
              <header class="Header" id="home">
                  ...
                  <div class="cover container-fluid text-black">
                      <div class="cover-content d-flex flex-column justify-content-center align-items-center">
                          <img class="rounded-circle" alt="" src="https://images.unsplash.com/photo-1542178243-bc20204b769f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80">
                          <h1 class="display-2 text-capitalize text-black">I Am John Doe</h1>
                          <h6 class="pt-3 h4">Graphic Artist - Web Designer - Illustrator</h6>
                      </div>
                  </div>
              ...
              <section class="container py-5" id="portfolio">
                  <div class="section-title text-center pt-2">
                      ...
                      <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sem orci, rutrum aliquet lectus ac, pharetra porttitor velit. Phasellus id.</p>
                  </div>
                  <div class="row">
                  ...
                  <div class="container about-content">
                      ...
                      <div class="row">
                          <div class="col-md-6">
                              ...
                              <p style="text-align: justify" class="text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec lacus purus, placerat eu est non, laoreet efficitur mauris. Quisque bibendum ultrices arcu non aliquet. Phasellus odio libero, tincidunt sed nisl sit amet, sodales vestibulum odio. Sed id nisi sit amet odio dignissim consequat</p>
                              <p style="text-align: justify" class="text-muted">Maecenas porttitor ornare orci. Aenean nulla tellus, viverra sit amet sapien et, vehicula porta nulla. Nunc nec varius dui. Vestibulum placerat sapien sollicitudin orci tempus, at molestie enim consectetur. Aliquam sed purus blandit, aliquam felis sed, tincidunt ante. Nunc eu consectetur orci, a gravida neque. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Orci varius natoque penatibus et magnis dis parturient montes.</p>
                          </div>
                          <div class="col-md-6">
                              ...
                              <div class="progress my-2 border border-warning bg-white">
                                  <div class="progress-bar progress-bar-striped progress-bar-animated bg-warning" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="62" style="width: 62%">62%</div>
                              </div>
                              <h6>Bootstrap:</h6>
              ...
              <footer class="text-center bg-dark mb-0 py-4">
                  <p class="text-white m-0">@All Right Reserved || made by (Name)</p>
              </footer>
