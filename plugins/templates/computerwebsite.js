...
export default (editor, opts = {}) => {
    ...
    *::after {
    ...
    bm.add(opts.name, {
      ...
      content: `<link href='https://unpkg.com/boxicons@2.0.7/css/boxicons.min.css' rel='stylesheet'>

      <body>
        <header>
          <div class="company-logo">PERFEC2 COMPUTER</div>
          <nav class="navbar">
            <ul class="nav-items">
        ...
        <main>
          ...
          <section class="container section-1">
            <div class="slogan">
              <h1 class="company-title">Perfec2 Computers</h1>
        ...
        <footer>
          ...
          <div class="container end-footer">
            <div class="copyright">copyright © 2022 - Present • <b>Perfec2 Tech</b></div>
            <a class="designer" href="#">Perfec2 Tech</a>
          </div>
        </footer>
      </body>
    ${panelStyle}`,
